...
3. Click "Create Database" and name it something that you will remember, i.e. "teams-api-db" and enter "tbd" for the collection name (we will be deleting this collection once the database is populatd - see below).

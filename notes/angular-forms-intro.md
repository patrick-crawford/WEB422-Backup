...
It builds upon your experience with one-way read-only data binding (using interpolation syntax, ie: "curly braces"), by going further with two-way data binding. 

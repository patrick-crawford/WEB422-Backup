...
![Angular CLI web site](/web422/media/angular-cli-web-site.png)
...
![Server is running](/web422/media/angular-server-process.png)
...
![New app folder structure](/web422/media/angular-cli-project-structure-2.png)

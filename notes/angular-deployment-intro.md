...
![Netlify sites screenshot](/web422/media/angular-deployment-5.png)
...
3. Add the publish directory: `dist/NAME_OF_YOUR_APP`.
    ...
    ![Netlify sites screenshot](/web422/media/angular-deployment-6.png)
...
4. Click "Deploy site".
    ...
    ![Site overview screenshot](/web422/media/angular-deployment-7.png)
